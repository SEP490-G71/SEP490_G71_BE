...
public class MetricController {
    ...
    @GetMapping("/{id}")
    public ApiResponse<AlertResponse> getById(@PathVariable String id) {
        log.info("Controller: get metric alert detail id={}", id);
        AlertResponse res = metricAlertService.getAlertById(id);
