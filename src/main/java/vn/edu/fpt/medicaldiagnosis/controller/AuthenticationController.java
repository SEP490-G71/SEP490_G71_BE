...
public class AuthenticationController {
    ...
    public ApiResponse<Tenant> register(@RequestBody @Valid TenantRequest request) {
    ...
    public ApiResponse<String> forgotPassword(@Valid @RequestBody ForgetPasswordRequest request) {
