...
public class DefaultDataSeeder {
    ...
    public static final List<PermissionSeed> DEFAULT_PERMISSIONS = List.of(
            ...
            new PermissionSeed("SPECIALIZATIONS:READ", "Xem chuyên khoa", "Quản lý chuyên khoa"),
            new PermissionSeed("SPECIALIZATIONS:CREATE", "Thêm chuyên khoa", "Quản lý chuyên khoa"),
            ...
            new PermissionSeed("STAFF-FEEDBACKS:READ", "Xem phản hồi bác sĩ", "Quản lý phản hồi bác sĩ"),
            new PermissionSeed("STAFF-FEEDBACKS:CREATE", "Thêm phản hồi bác sĩ", "Quản lý phản hồi bác sĩ"),
            ...
            new PermissionSeed("MEDICAL-SERVICE-FEEDBACKS:READ", "Xem phản hồi dịch vụ", "Quản lý phản hồi dịch vụ"),
            new PermissionSeed("MEDICAL-SERVICE-FEEDBACKS:CREATE", "Thêm phản hồi dịch vụ", "Quản lý phản hồi dịch vụ"),
    ...
    public void seedDefaultData(Tenant tenant) {
        ...
        jdbcTemplate.update(
                "INSERT INTO settings (" +
                        ...
                        "monthly_target_revenue, doc_shift_quota, created_at, updated_at" +
                        ") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())",
