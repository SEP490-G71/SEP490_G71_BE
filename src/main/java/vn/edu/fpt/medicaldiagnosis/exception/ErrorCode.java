...
public enum ErrorCode {
    ...
    SHIFTS_REQUIRED(2202, "Shifts is required", HttpStatus.BAD_REQUEST),
    ...
    SERVICE_PACKAGE_DUPLICATE_NAME(2311, "Service package with the same name already exists for this tenant", HttpStatus.CONFLICT),
    SERVICE_PACKAGE_QUANTITY_REQUIRED(2312, "Quantity is required", HttpStatus.BAD_REQUEST),
    SERVICE_PACKAGE_QUANTITY_MIN_1(2313, "Quantity must be at least 1", HttpStatus.BAD_REQUEST),
    TENANT_CODE_REQUIRED(2314, "Tenant code is required", HttpStatus.BAD_REQUEST),
    SERVICE_PACKAGE_ID_REQUIRED(2315, "Service package ID is required", HttpStatus.BAD_REQUEST),
    ...
    TRANSACTION_SERVICE_PACKAGE_ID_REQUIRED(2503, "Service package ID is required", HttpStatus.BAD_REQUEST),
    TRANSACTION_PRICE_REQUIRED(2504, "Price is required", HttpStatus.BAD_REQUEST),
