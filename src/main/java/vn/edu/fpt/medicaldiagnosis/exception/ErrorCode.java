...
public enum ErrorCode {
    ...
    VALIDATION_FAILED(1007, "Validation failed", HttpStatus.BAD_REQUEST),
    ...
    OLD_PASSWORD_EMPTY(1107, "Old password is required", HttpStatus.BAD_REQUEST),
    NEW_PASSWORD_EMPTY(1108, "New password is required", HttpStatus.BAD_REQUEST),
    CONFIRM_NEW_PASSWORD_EMPTY(1109, "Confirm new password is required", HttpStatus.BAD_REQUEST),
    PASSWORD_CONFIRM_NOT_MATCH(1111, "New password and confirm password do not match", HttpStatus.BAD_REQUEST),
    INVALID_OLD_PASSWORD(1112, "Old password is invalid", HttpStatus.BAD_REQUEST),
    NEW_PASSWORD_INVALID(1113, "New password is invalid. It must be at least 8 characters long, contain at least one uppercase letter, one digit, and one special character (@$!%*?&)", HttpStatus.BAD_REQUEST),
    CONFIRM_NEW_PASSWORD_INVALID(1114, "Confirm new password is invalid. It must match the new password and follow the same rules: minimum 8 characters, at least one uppercase letter, one digit, and one special character (@$!%*?&)", HttpStatus.BAD_REQUEST),
    // ===== FORGET PASSWORD =====
    ...
    TENANT_NAME_REQUIRED(3003, "Tên bệnh viện là bắt buộc", HttpStatus.BAD_REQUEST),
    TENANT_CODE_REQUIRED(3004, "Mã bệnh viện là bắt buộc", HttpStatus.BAD_REQUEST),
    TENANT_EMAIL_REQUIRED(3005, "Email bệnh viện là bắt buộc", HttpStatus.BAD_REQUEST),
    TENANT_EMAIL_INVALID(3006, "Email bệnh viện không hợp lệ", HttpStatus.BAD_REQUEST),
    TENANT_PHONE_REQUIRED(3007, "Số điện thoại bệnh viện là bắt buộc", HttpStatus.BAD_REQUEST),
    TENANT_PHONE_INVALID(3008, "Số điện thoại bệnh viện không hợp lệ", HttpStatus.BAD_REQUEST),
    TENANT_SERVICE_PACKAGE_REQUIRED(3009, "Gói dịch vụ là bắt buộc", HttpStatus.BAD_REQUEST),
    ...
    VISIT_ID_REQUIRED(1814, "Visit ID is required", HttpStatus.BAD_REQUEST),
    SERVICES_REQUIRED(1815, "Services are required", HttpStatus.BAD_REQUEST),
    TEMPERATURE_TOO_LOW(1816, "Temperature is too low", HttpStatus.BAD_REQUEST),
    TEMPERATURE_TOO_HIGH(1817, "Temperature is too high", HttpStatus.BAD_REQUEST),
    RESPIRATORY_RATE_TOO_LOW(1818, "Respiratory rate is too low", HttpStatus.BAD_REQUEST),
    RESPIRATORY_RATE_TOO_HIGH(1819, "Respiratory rate is too high", HttpStatus.BAD_REQUEST),
    INVALID_BLOOD_PRESSURE(1820, "Invalid blood pressure", HttpStatus.BAD_REQUEST),
    HEART_RATE_TOO_LOW(1821, "Heart rate is too low", HttpStatus.BAD_REQUEST),
    HEART_RATE_TOO_HIGH(1822, "Heart rate is too high", HttpStatus.BAD_REQUEST),
    HEIGHT_TOO_LOW(1823, "Height is too low", HttpStatus.BAD_REQUEST),
    WEIGHT_TOO_LOW(1824, "Weight is too low", HttpStatus.BAD_REQUEST),
    BMI_TOO_LOW(1825, "BMI is too low", HttpStatus.BAD_REQUEST),
    BMI_TOO_HIGH(1826, "BMI is too high", HttpStatus.BAD_REQUEST),
    ...
    INVALID_OPERATION(1831, "Invalid operation", HttpStatus.BAD_REQUEST),
    // ===== file =====
