...
public enum ErrorCode {
    ...
    // ===== SERVICE PACKAGE =====
    SERVICE_PACKAGE_NOT_FOUND(2201, "Service package not found", HttpStatus.NOT_FOUND),
    SERVICE_PACKAGE_NAME_REQUIRED(2202, "Package name is required", HttpStatus.BAD_REQUEST),
    SERVICE_PACKAGE_NAME_LENGTH(2203, "Package name must be between 3 and 100 characters", HttpStatus.BAD_REQUEST),
    SERVICE_PACKAGE_DESCRIPTION_LENGTH(2204, "Description must be max 500 characters", HttpStatus.BAD_REQUEST),
    SERVICE_PACKAGE_TENANT_ID_REQUIRED(2205, "Tenant ID is required", HttpStatus.BAD_REQUEST),
    SERVICE_PACKAGE_BILLING_TYPE_REQUIRED(2206, "Billing type is required", HttpStatus.BAD_REQUEST),
    SERVICE_PACKAGE_STATUS_REQUIRED(2207, "Status is required", HttpStatus.BAD_REQUEST),
    SERVICE_PACKAGE_PRICE_REQUIRED(2208, "Price is required", HttpStatus.BAD_REQUEST),
    SERVICE_PACKAGE_PRICE_INVALID(2209, "Price must be greater than or equal to 0", HttpStatus.BAD_REQUEST),
    SERVICE_PACKAGE_DATE_INVALID(2210, "Start date must be before end date", HttpStatus.BAD_REQUEST),
