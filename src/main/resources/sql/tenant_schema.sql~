...
CREATE TABLE IF NOT EXISTS medical_services (
    ...
    default_service BOOLEAN NOT NULL DEFAULT FALSE,
    created_at TIMESTAMP,
    updated_at TIMESTAMP,
    deleted_at TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS room_transfer_histories (
                                       ...
                                       CONSTRAINT fk_room_transfer_medical_record FOREIGN KEY (medical_record_id) REFERENCES medical_records(id),
                                       CONSTRAINT fk_room_transfer_from_department FOREIGN KEY (from_department_id) REFERENCES departments(id),
                                       CONSTRAINT fk_room_transfer_to_department FOREIGN KEY (to_department_id) REFERENCES departments(id),
                                       CONSTRAINT fk_room_transfer_transferred_by FOREIGN KEY (transferred_by) REFERENCES staffs(id),
